...
from .models import Command, Task, FollowedTask

# Register your models here.

@admin.register(Command)
class CommandAdmin(admin.ModelAdmin):
    list_display = ('pk', 'protocol_type', 'destination', 'protocol_conf', 'create_time')
...
class TaskAdmin(admin.ModelAdmin):
    ...
    list_filter = ('scope', 'time_type', 'purpose', 'command__protocol_type')
